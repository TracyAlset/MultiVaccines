...
and then the second table shows the oercentage of people who got infected and didn't get infected in each category of vaccination.and it shows that the first+new group has the least percentage of infection, while the none group has the highest percentade of infection.
